...
train = pd.read_csv("exampleDatasetMLC/train2.csv")
test = pd.read_csv("exampleDatasetMLC/test2.csv")
...
df = DTE( task = "mlc", features = features, prediction_features = prediction_features, path_features = path_features)
